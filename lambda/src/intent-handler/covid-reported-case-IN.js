...
const IndianStateCovidCaseCountHandler = {
    
    canHandle(handlerInput) {
        return Alexa.getRequestType(handlerInput.requestEnvelope) === 'IntentRequest'
            && Alexa.getIntentName(handlerInput.requestEnvelope) === 'IndianStateCovidCaseCount';
    },
    ...
    async handle(handlerInput) {
        ...
        try {
            ...
            if(state) {
                speakOutput = state.totalConfirmed + " cases have been reported till now!";
            }
            else {
...
module.exports = IndianStateCovidCaseCountHandler;